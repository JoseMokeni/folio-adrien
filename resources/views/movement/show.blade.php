    ...
    <div class="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="glass-morphism rounded-2xl p-8 border border-white/10">
            ...
            <div class="flex items-center mb-8">
                <div class="p-3 rounded-xl bg-gradient-to-br from-{{ $movement->nature === 'income' ? 'success' : 'danger' }}-100 to-{{ $movement->nature === 'income' ? 'success' : 'danger' }}-200 mr-4">
                    <svg class="w-6 h-6 text-{{ $movement->nature === 'income' ? 'success' : 'danger' }}-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <span class="px-3 py-1 text-sm font-medium rounded-full {{ $movement->nature === 'income' ? 'bg-success-100 text-success-800' : 'bg-danger-100 text-danger-800' }}">
            ...
            <div class="mt-6 glass-morphism rounded-xl p-6 border border-white/10 border-dashed">
                <div class="flex items-center justify-center py-4">
                    <div class="text-center">
                        <div class="p-3 rounded-xl bg-gradient-to-br from-secondary-100 to-secondary-200 mx-auto w-fit mb-3">
                        ...
                        @can('update', $movement)
                        <p class="text-secondary-400 text-xs mt-1">Modifiez la transaction pour ajouter une description</p>
                        @endcan
                    </div>
                </div>
            </div>
