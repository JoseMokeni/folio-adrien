        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-8">
            ...
            <div class="card-hover glass-morphism rounded-3xl p-6 relative overflow-hidden group">
                ...
                <div class="relative flex items-center gap-4">
                    <div class="flex-shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center shadow-lg">
            ...
            <div class="card-hover glass-morphism rounded-3xl p-6 relative overflow-hidden group">
                ...
                <div class="relative flex items-center gap-4">
                    <div class="flex-shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br from-success-500 to-success-600 flex items-center justify-center shadow-lg">
                        <svg class="h-7 w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-medium text-secondary-600 mb-1">Comptes actifs</p>
                        <div class="flex items-baseline space-x-2">
                            @php
            ...
            <!-- Quick Action Card -->
            <div class="card-hover glass-morphism rounded-3xl p-6 relative overflow-hidden group sm:col-span-2 lg:col-span-1">
                ...
                <div class="relative text-center">
                    <div class="w-14 h-14 mx-auto rounded-2xl bg-gradient-to-br from-accent-500 to-accent-600 flex items-center justify-center shadow-lg mb-4">
                        <svg class="h-7 w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                    </div>
                    <p class="text-sm font-medium text-secondary-600 mb-3">Action rapide</p>
                    <a href="{{ route('movement.create') }}"
                        class="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-accent-500 to-accent-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg hover:shadow-xl hover:from-accent-600 hover:to-accent-700 transition-all duration-300 transform hover:scale-105">
        ...
        <div class="glass-morphism rounded-3xl overflow-hidden shadow-glass border border-white/10">
            <div class="px-6 py-6 border-b border-white/10 bg-gradient-to-r from-white/5 to-white/0">
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                    <div>
                        <h2 class="text-2xl font-bold text-secondary-800 mb-2">Transactions récentes</h2>
                        <p class="text-sm text-secondary-600">Gérez et suivez vos mouvements financiers</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        <button class="inline-flex items-center gap-2 rounded-xl bg-white/50 hover:bg-white/70 px-4 py-2.5 text-sm font-medium text-secondary-700 shadow-soft hover:shadow-md transition-all duration-300 border border-white/20">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
