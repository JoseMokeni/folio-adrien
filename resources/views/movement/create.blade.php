                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="label" name="label" required value="{{ old('label') }}"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select id="nature" name="nature" required
                                    ...
                                    <option value="income" {{ old('nature') == 'income' ? 'selected' : '' }}>💰 Revenu
                                        (Entrée d'argent)</option>
                                    <option value="expense" {{ old('nature') == 'expense' ? 'selected' : '' }}>💸
                                        Dépense (Sortie d'argent)</option>
                                </select>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <textarea id="description" name="description" rows="3"
                                ...
                                class="block w-full pl-10 pr-4 py-3 bg-white/50 rounded-xl border border-white/20 text-secondary-900 placeholder-secondary-500 shadow-soft backdrop-blur-sm focus:border-primary-400 focus:ring-2 focus:ring-primary-400/30 focus:bg-white/70 transition-all duration-300 sm:text-sm resize-none">{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <p
                                class="mt-2 text-sm text-danger-600 bg-danger-50 rounded-lg px-3 py-2 border border-danger-200">
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <ul class="text-sm text-secondary-600 space-y-1">
                        <li>• <strong>Revenus :</strong> Salaires, primes, cadeaux, remboursements... (catégorie
                            optionnelle)</li>
                        <li>• <strong>Dépenses :</strong> Achats, factures, loisirs... (catégorie obligatoire pour
                            l'analyse)</li>
                        <li>• <strong>Montant :</strong> Entrez toujours le montant positif, le type détermine le sens
                        </li>
