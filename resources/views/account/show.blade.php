    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-secondary-600">
                            Consultez les informations et l'historique de <span
        ...
        <div class="glass-morphism rounded-2xl p-8 border border-white/10 mb-8">
            ...
            <div class="flex items-center mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-secondary-600 mt-1">Compte bancaire • Créé le
        ...
        <div class="glass-morphism rounded-2xl p-8 border border-white/10">
            ...
            @if ($movements->isEmpty())
                <div
                    class="flex flex-col items-center justify-center py-12 glass-morphism rounded-xl border border-white/10">
                        ...
                        <a href="{{ route('movement.show', $movement->id) }}"
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-4">
                                    <div
                                        class="p-3 rounded-xl {{ $movement->nature === 'income' ? 'bg-gradient-to-br from-success-100 to-success-200' : 'bg-gradient-to-br from-danger-100 to-danger-200' }}">
                                    ...
                                    <div>
                                        <p
                                            class="font-semibold text-secondary-900 group-hover:text-primary-600 transition-colors">
                                            {{ $movement->label }}</p>
                                        <div class="flex items-center gap-2 mt-1">
                                            ...
                                            @if ($movement->category)
                                                <span
                                                    class="px-2 py-1 text-xs font-medium bg-white/50 text-secondary-600 rounded-lg">
                                ...
                                <div class="text-right">
                                    <p
                                        class="font-bold {{ $movement->nature === 'income' ? 'text-success-600' : 'text-danger-600' }}">
                                        {{ $movement->nature === 'income' ? '+' : '-' }}
                                        {{ number_format($movement->amount, 2) }}
                                        {{ strtoupper($movement->currency) }}
                                    </p>
