                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-secondary-600 space-y-1">
                            <li>• <strong>Nom du compte :</strong> Utilisez un nom descriptif (ex: "Compte Courant BNP",
                                "Carte Crédit Visa")</li>
                            <li>• <strong>Solde initial :</strong> Entrez le solde actuel de votre compte au moment de
                                la création</li>
